...
public class Main {
    public static void main(String[] args) {
        ...
        if (isBetween(k, -10 * k, 5)) {
            interval_number = 1;
        } else if (isBetween(k, 0, 10)) {
            interval_number = 2;
        } else if (isBetween(k, 5, 15)) {
            interval_number = 3;
        ...
        switch (interval_number) {
            case 0:
                ...
                break;
            case 1:
                System.out.println("k in (-10k, 5]");
                break;
            case 2:
                System.out.println("k in (0, 10]");
                break;
            case 3:
                System.out.println("k in (5, 15]");
                break;
            case 4:
